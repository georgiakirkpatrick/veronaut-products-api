...
const { 
    ...
    makeMaliciousCertification, makeFabricsArray, makeFabricsArrayWithTypes, makeMaliciousFiber, makeFibersArray, 
    makeFactoriesArray,makeFabricsToFibers,makeFibersToFactories,makeFabricsToCertifications, makeFabricsToFactories, 
    makeMaliciousFabricType, makeMaliciousFactoriesArray, makeMaliciousFiberType, makeMaliciousNotionType, 
    makeMaliciousNotion, makeMaliciousFabric, makeMaliciousFibersToFactories, makeFabricsToMaliciousFibers, 
            ...
            it('returns all the fibers for the fabric with fabric_id', () => {
                return supertest(app)
                    ...
                    .expect(res => {
                        ...
                        expect(res.body[0].fiber_or_material_type_id).to.eql(fibers[0].fiber_or_material_type_id)
                        ...
                        expect(res.body[0].producer_notes).to.eql(fibers[0].producer_notes)
